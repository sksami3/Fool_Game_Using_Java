...
public class yes extends JFrame implements ActionListener, MouseListener
{
	...
	public yes()
	{
		...
		l2=new JLabel("Yes, you are a fool");
		...
		againButton.setBounds(400,350,100,30);
		againButton.addMouseListener(this);
		againButton.addActionListener(this);
		panel.add(againButton);
		
		exitButton = new JButton("Exit");
		exitButton.setBounds(270,350,100,30);
